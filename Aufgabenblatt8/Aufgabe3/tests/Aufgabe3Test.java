...
public class Aufgabe3Test {
    ...
    public void testNegamax() throws Exception {
        ...
        f = f.zug(2,3);
        f = f.zug(2,2);
        assertEquals(-101,f.negamax(1,0,new HashMap<>()));
        assertEquals( 101,f.negamax(2,0,new HashMap<>()));
        assertEquals( -99,f.negamax(1,1,new HashMap<>()));
        assertEquals( 103,f.negamax(2,1,new HashMap<>()));
        assertEquals(-101,f.negamax(1,2,new HashMap<>()));
        assertEquals( 101,f.negamax(2,2,new HashMap<>()));
    }
